...
impl BoardState {
    ...
    pub fn make_move(&mut self, mv: Move) {
        ...
        } else if mv.kind == MoveType::RookPromotionCapture
            || mv.kind == MoveType::BishopPromotionCapture
            || mv.kind == MoveType::KnightPromotionCapture
